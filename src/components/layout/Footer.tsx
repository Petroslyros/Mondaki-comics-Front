...
const Footer = () => {
    ...
    const socialLinks = [
        {
            name: "Instagram",
            url: "https://instagram.com/mondaki",
            icon: FaInstagram,
        },
        {
            name: "Facebook",
            url: "https://facebook.com/mondaki",
            icon: FaFacebookF,
        },
        {
            name: "Email",
            url: "mailto:mondaki@example.com",
            icon: Mail,
        },
    ];

    return (
        <footer className="bg-[#16213e] text-gray-300 border-t border-[#0f3460]">
