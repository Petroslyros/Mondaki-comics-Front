            ...
            <div className="container mx-auto px-6 py-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                    <div className="text-center md:text-left">
                        <img src="/logo-light.png" alt="MondakiComics" className="h-20 w-34 mx-auto md:mx-0 dark:hidden mb-2" />
                        <img src="/logo-dark.png" alt="MondakiComics" className="h-20 w-34 mx-auto md:mx-0 hidden dark:block mb-2" />
